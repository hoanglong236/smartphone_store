...
@section('container')
                    ...
                    <div class="aa-product-catg-content">
                        <div class="aa-product-catg-head">
                            <div class="aa-product-catg-head-left">
                                <h3><b>{{ $result['category']->category_name }}</b></h3>
                            </div>
                        </div>
                        <div class="aa-product-catg-head">
                            <div class="aa-product-catg-head-left">
                        ...
                        <div class="row">
                            <input id="category_slug" type="hidden" value="{{ $result['category']->category_slug }}"
                                readonly>
    ...
    <script src="{{ asset('consumer_assets/js/productPagination.js') }}"></script>
@endsection
