...
@section('container')
    ...
    <div class="row m-t-30">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Add Product Detail Options</div>
                <div class="card-body">
                    <form
                        action="{{ route('admin.product_detail.update_product_detail_handle') }}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            aria-invalid="false" rows="4">{{ $product_detail->short_desc }}</textarea>
                        </div>
