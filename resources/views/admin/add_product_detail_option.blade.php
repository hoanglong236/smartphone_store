...
@section('container')
    ...
    <div class="row m-t-30">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Add Product Detail Option</div>
                <div class="card-body">
                    <form id="add_product_detail_option_form" action="{{ route('admin.product_detail.add_product_detail_option_handle') }}" method="post">
                        @csrf
                        ...
                        @if ($product_detail->product_option_name_1 == null)
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="product_option_name_1" class="control-label mb-1">Option Name</label>
                                        <input id="option_name_1" name="product_option_name_1" type="text" class="form-control"
                                            aria-required="true" aria-invalid="false" required>
                                        @error('product_option_name_1')
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="product_option_value_1" class="control-label mb-1">Option Value</label>
                        ...
                        @elseif ($product_detail->product_option_name_2 == null)
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="product_option_name_1" class="control-label mb-1">Option Name 1</label>
                                        <input id="option_name_1" name="product_option_name_1" type="text"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="option_name_2" name="product_option_name_2" type="text"
                                        ...
                                        @enderror
                                        <div id="check_unique_constraint" class="alert alert-danger" role="alert" style="display: none;"></div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                        ...
                        @elseif ($product_detail->product_option_name_3 == null)
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="product_option_name_1" class="control-label mb-1">Option Name 1</label>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="product_option_name_2" class="control-label mb-1">Option Name 2</label>
                                        <input id="option_name_2" name="product_option_name_2" type="text" class="form-control"
                                            aria-required="true" aria-invalid="false"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="option_name_3" name="product_option_name_3" type="text" class="form-control"
                                            aria-required="true" aria-invalid="false" required>
                        ...
                        <button id="submit_form_btn" type="button" class="btn btn-lg btn-info btn-block">
                            Submit
                        </button>
                    </form>
                </div>
    ...
    <script>
        var add_product_detail_option_form = document.getElementById('add_product_detail_option_form');

        var option_name_1 = document.getElementById('option_name_1');
        var option_name_2 = document.getElementById('option_name_2');
        var option_name_3 = document.getElementById('option_name_3');

        var check_unique_constraint = document.getElementById('check_unique_constraint');
        
        submit_form_btn.addEventListener('click', function() {

            if (option_name_3 != null){
                if (option_name_3.value == option_name_2.value || option_name_3.value == option_name_1.value){
                    check_unique_constraint.innerHTML = "Option Name must be unique.";
                    check_unique_constraint.removeAttribute("style");
                }
                else add_product_detail_option_form.submit();
            }
            else {
                if (option_name_2 != null){
                    if (option_name_2.value == option_name_1.value){
                        check_unique_constraint.innerHTML = "Option Name must be unique.";
                        check_unique_constraint.removeAttribute("style");
                    }
                    else add_product_detail_option_form.submit();
                    ...
                    if (option_name_1 != null){
                        add_product_detail_option_form.submit();
                    }
                }
            }
        })
