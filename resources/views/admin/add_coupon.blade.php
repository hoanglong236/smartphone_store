...
@section('container')
    ...
    <div class="row m-t-30">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.coupon.add_coupon_handle') }}" method="post">
                        @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-control" style="border-style: none">
                                        <input id="is_percent_radio" class="form-check-input" type="radio"
                                            name="coupon_type" value="Percent" checked>
                                        <label for="coupon_type">Percent (%)</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-control" style="border-style: none">
                                        <input id="is_not_percent_radio" class="form-check-input" type="radio"
                                            name="coupon_type" value="Dollar">
                                        <label for="coupon_type">Dollar ($)</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <input id="percent_value_field" name="coupon_percent_value" type="number" min="0"
                                        max="100" class="form-control" aria-required="true" aria-invalid="false" required>
                                </div>
                            </div>
                            <div class="col-sm">
                                <div class="form-group">
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <select name="coupon_status" class="form-control">
                                        <option value="Stocking" selected>Stocking</option>
    ...
    <script>
        ...
        is_percent_radio.addEventListener('click', function() {
            ...
            dollar_value_field.setAttribute('disabled', "true");
        ...
        is_not_percent_radio.addEventListener('click', function() {
            ...
            percent_value_field.setAttribute('disabled', "true");
