  ...
  <div class="row m-t-30">
    <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            @foreach ($category_data as $category)
              @if ($category->id == $product->category_id)
                <input name="category_id" type="text" class="form-control" aria-required="true" aria-invalid="false"
        ...
        <div class="form-group">
          ...
          @foreach ($brand_data as $brand)
            @if ($brand->id == $product->brand_id)
              <input name="brand_id" type="text" class="form-control" aria-required="true" aria-invalid="false"
      ...
      <div class="form-group">
        ...
        <input name="product_name" type="text" class="form-control" aria-required="true" aria-invalid="false"
      ...
      <div class="form-group">
        ...
        <input name="product_slug" type="text" class="form-control" aria-required="true" aria-invalid="false"
      ...
      <div class="form-group">
        ...
        <div class="product_image_container">
          <img class="product_image" src="{{ asset('/storage/product_image/' . $product->product_main_image) }}">
        </div>
      </div><br>
    </div>
  </div>
        ...
        @foreach ($image_data as $product_image)
          <tr>
            ...
            <td class="align-middle">
              <div class="product_image_container">
                <img class="product_image" src="{{ asset('/storage/product_image/' . $product_image->image) }}">
              </div>
            </td>
            <td class="align-middle">
      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input name="product_option_name_1" type="text" class="form-control" aria-required="true"
                    aria-invalid="false" value={{ $product_detail->product_option_name_1 }} readonly>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="product_option_value_1" class="control-label mb-1">Option Value
                    1</label>
                  <input name="product_option_value_1" type="text" class="form-control" aria-required="true"
                    aria-invalid="false" value="{{ $product_detail->product_option_value_1 }}" readonly>
                </div>
              </div>
            </div>
          @endif
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input name="product_option_name_2" type="text" class="form-control" aria-required="true"
                    aria-invalid="false" value={{ $product_detail->product_option_name_2 }} readonly>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="product_option_value_2" class="control-label mb-1">Option Value
                    2</label>
                  <input name="product_option_value_2" type="text" class="form-control" aria-required="true"
                    aria-invalid="false" value="{{ $product_detail->product_option_value_2 }}" readonly>
                </div>
              </div>
            </div>
          @endif
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input name="product_option_name_3" type="text" class="form-control" aria-required="true"
                    aria-invalid="false" value={{ $product_detail->product_option_name_3 }} readonly>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="product_option_value_3" class="control-label mb-1">Option Value
                    3</label>
                  <input name="product_option_value_3" type="text" class="form-control" aria-required="true"
                    aria-invalid="false" value="{{ $product_detail->product_option_value_3 }}" readonly>
                </div>
              </div>
            </div>
          @endif
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input name="quantity" type="number" min="0" class="form-control" aria-required="true"
                  aria-invalid="false" value="{{ $product_detail->quantity }}" readonly>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input name="discount_percent" type="number" min="0" max="100" class="form-control"
                  aria-required="true" aria-invalid="false" value="{{ $product_detail->discount_percent }}"
                  readonly>
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input name="warranty_period" type="number" min="1" max="60" class="form-control"
                  aria-required="true" aria-invalid="false" value="{{ $product_detail->warranty_period }}"
                  readonly>
              </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <textarea name="short_desc" class="form-control" aria-required="true" aria-invalid="false" rows="4" readonly>{{ $product_detail->short_desc }}</textarea>
          </div>
        </div>
      </div>
      @if ($product_detail->product_option_name_3 == null)
